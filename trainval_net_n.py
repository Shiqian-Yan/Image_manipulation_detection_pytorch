...
from model.faster_rcnn.vgg16_n import vgg16
from model.faster_rcnn.resnet_n import resnet
...
if __name__ == '__main__':
    ...
    if args.dataset == "voc_2012":
        args.imdb_name = "voc_2012_train"
    ...
    # dataset_noise = roibatchLoader(roidb, ratio_list, ratio_index, args.batch_size, \
    #                          imdb.num_classes, training=True)

    dataloader = torch.utils.data.DataLoader(dataset, batch_size=args.batch_size,
                                             sampler=sampler_batch, num_workers=args.num_workers)
    # dataloader_rgb = torch.utils.data.DataLoader(dataset_rgb, batch_size=args.batch_size,
    #                           sampler=sampler_batch, num_workers=args.num_workers)
