...
class _fasterRCNN(nn.Module):
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes):
        ...
        pooled_feat = pooled_feat.unsqueeze(-1)
        pooled_feat = pooled_feat.unsqueeze(-1)
        pooled_feat_n = pooled_feat_n.unsqueeze(-1)
        pooled_feat_n = pooled_feat_n.unsqueeze(-1)
        Bipooling = CompactBilinearPooling(pooled_feat.shape[1], pooled_feat.shape[1], pooled_feat.shape[1]*8).cuda()
